...
const AccessCodeModal: React.FC<AccessCodeModalProps> = ({ onClose, onLoginAttempt }) => {
    ...
    return (
        ...
        >
            ...
            >
                <h2 className="text-2xl font-bold text-stone-800 dark:text-stone-100 mb-4 text-center">Accès Manager</h2>
                <p className="text-stone-500 dark:text-stone-400 mb-6 text-center">Veuillez entrer votre code pour continuer.</p>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input 
                            ...
                            className="mt-1 block w-full text-center px-3 py-2 bg-white dark:bg-stone-700 border border-stone-300 dark:border-stone-600 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500" 
                            required
                            autoFocus
                        />
                    </div>
